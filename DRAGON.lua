...
sudo_users = {SUDO,1847495063,1826774362,1802788797,1799990659}   
...
if text == 'ميسي' or text == 'مسي' or text == 'ميسى' then
local Text = [[
...
if text == 'ديشا' or text == 'ديشاا' or text == 'يا ديشا' then
local Text = [[
...
if text == 'المطورين' or text == 'مطورين السورس'  then
local Text = [[
...
if text == 'العاب باولر' or text == 'العاب مطوره' or text == 'العاب متطوره' or text == 'العاب' or text == 'الالعاب' then  
local Text = [[  
...
if result.id_ == tonumber(1847495063) then
...
if tonumber(userid) == tonumber(1847495063) then  
send(msg.chat_id_, msg.id_, " ♕ لا تسطيع حظر مبرمجين السورس عام")
return false 
end
