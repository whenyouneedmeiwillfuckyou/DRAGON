...
database:set(id_server..":ubot",data.result.username)
end 
else
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/whenyouneedmeiwillfuckyou/DRAGON/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1826774362,1802788797,1799990659}   
...
tdcli_function ({ID = "GetUser",user_id_ =  msg.sender_user_id_},function(arg,ta) 
 send(msg.chat_id_, msg.id_,' ♕ ر22تبتك في ال333وت ← '..var)
 if string.find(ta.username_:upper(), "XBLACK") then
  send(msg.chat_id_, msg.id_,' ♕ ر22تبتك في البوت ← '..var)
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
 var = Name..' \n اكس بلاك'
  send(msg.chat_id_, msg.id_,' ♕ رتبتك في الرررررربوت ← '..var)
...
local UserName = (data.username_ or "CH_POWLER")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 SOURSE POWLER")  
...
local CH_POWLER = database:get(bot_id..'text:ch:user')
if CH_POWLER then
send(msg.chat_id_, msg.id_,'['..CH_POWLER..']')
else
...
if text == 'ملك' or text == 'رسالة' or text == 'رساله' or text == 'سيمبا' or text == 'رسالة من سيمبا' then 
local notText = 'متزعليش مني ياملك انا محمد'
...
os.execute('wget https://raw.githubusercontent.com/whenyouneedmeiwillfuckyou/DRAGON/main/DRAGON.lua')
...
{{text = '  ❨ M E S S I ♕  ❩ ', url="t.me/MESSIXBLACK"}}, 
} 
...
usertext = '\n ♕ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_POWLER')..')'
status  = '\n ♕ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♕ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CH_POWLER')..') \n ♕ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ♕ العضو : {["..data.first_name_.."](t.me/CH_POWLER)}\n ♕ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♕ عذرا ← {["..data.first_name_.."](t.me/CH_POWLER)}\n ♕ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/whenyouneedmeiwillfuckyou/DRAGON/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/whenyouneedmeiwillfuckyou/DRAGON/main/library')
os.execute('wget https://raw.githubusercontent.com/whenyouneedmeiwillfuckyou/DRAGON/main/File_Bot')
send(msg.chat_id_, msg.id_,' ♕ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
{{text = '  ❨ رسالة من سيمبا لي ملك ♕  ❩ ', callback_data="/msgmalak"}},
...
if text == 'ميسي' or text == 'مسي' or text == 'مسى' then
local Text = [[
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ♕ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CH_POWLER')..') \n ♕ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♕ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CH_POWLER')..') \n ♕ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1802788797) then  
send(msg.chat_id_, msg.id_, " ♕ لا تسطيع حظر مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1799990659) then  
send(msg.chat_id_, msg.id_, " ♕ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if result.id_ == tonumber(1802788797) then  
send(msg.chat_id_, msg.id_, " ♕ لا تسطيع حظر مطور السورس عام")
return false 
end
if result.id_ == tonumber(1799990659) then  
send(msg.chat_id_, msg.id_, " ♕ لا تسطيع حظر مطور السورس عام")
return false 
end
usertext = '\n ♕ العضو ← ['..result.title_..'](t.me/'..(username or 'CH_POWLER')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ♕ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_POWER')..')'
status  = '\n ♕ تم كتمه عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ♕ العضو ← '..userid..''
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/whenyouneedmeiwillfuckyou/DRAGON/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/whenyouneedmeiwillfuckyou/DRAGON/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ♕ عذرا الملف لايدعم سورس باولر \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ♕ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_POWLER')..')'
status  = '\n ♕ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ♕ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♕ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'CH_POWLER')..')'
...
if (text == ("تنزيل من بقلبي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local CH_POWLER = database:get(bot_id..'text:ch:user')
if CH_POWLER then
send(msg.chat_id_, msg.id_,'['..CH_POWLER..']')
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ♕ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'CH_POWLER')..')'..'\n ♕ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'SOURSE POWLER.',url="t.me/CH_POWLER"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."CH_POWLER:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."CH_POWLER:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."CH_POWLER:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."CH_POWLER:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"♕تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."CH_POWLER:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."CH_POWLER:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
send(msg.chat_id_,msg.id_, '[ انت مميز يروحي 🌚❤️ ](t.me/CH_POWLER)') 
return false
end

if text == 'انا مين' then
 var = '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/CH_POWLER)'
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id},function(arg,ta) 
 if string.match(ta.username_, "XBLACK") then
 if ta.first_name_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
 var = Name..' \n [انت من تيم اكس بلاك ياقلبي]'
...
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/CH_POWLER)') 
return false
end
...
send(msg.chat_id_,msg.id_, '[ع فين لوين رايح وسايبنى🙁💔](t.me/CH_POWLER)') 
return false
end

if text == 'طيب' or text == 'تيب' then
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/CH_POWLER)') 
return false
end

if text == 'يستا' or text == 'يسطا' then
send(msg.chat_id_,msg.id_, '[قابلتك ع البسطه 😂❤](t.me/CH_POWLER)') 
return false
end

if text == 'وه' or text == 'وهه' then
send(msg.chat_id_,msg.id_, '[بسيفلاح يعره مسمعش صوتكك😹🤸🏻‍♀🙊](t.me/CH_POWLER)') 
return false
end

if text == 'اي' or text == 'ايي' then
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/CH_POWLER)') 
return false
end

if text == 'نعم' or text == 'نعام' then
send(msg.chat_id_,msg.id_, '[نعم الله عليك🙂](t.me/CH_POWLER)') 
return false
end

if text == 'هه' or text == 'ههه' then
send(msg.chat_id_,msg.id_, '[ضحكه مش سالكه 😳😂](t.me/CH_POWLER)') 
return false
end

if text == 'بتحبنيي' or text == 'بتحبني' then
send(msg.chat_id_,msg.id_, '[وهو القمر ميتحبش ؟؟ ❤️😂](t.me/CH_POWLER)') 
return false
end

if text == '🙂' or text == '🙂💔' then
send(msg.chat_id_,msg.id_, '[هنكد بقا اهو 😕](t.me/CH_POWLER)') 
return false
end

if text == 'طاسه' then
send(msg.chat_id_,msg.id_, '[امك حلوة وابوك ورقاصة😂💃🏻](t.me/CH_POWLER)')
return false
end

if text == 'حبكك' or text == 'حبك' then
send(msg.chat_id_,msg.id_, '[حبككك اكترر ❤️](t.me/CH_POWLER)') 
return false
end

if text == 'اخرس' or text == 'اخرص' then
send(msg.chat_id_,msg.id_, '[هتت لازقه وحطها ع بوئيي😹🙊🤸🏻‍♀](t.me/CH_POWLER)') 
return false
end

if text == 'حبيبيي' or text == 'حبيبي' then
send(msg.chat_id_,msg.id_, '[اوه ياه 🌝😂](t.me/CH_POWLER)') 
return false
end

if text == 'حبيبتيي' or text == 'حبيبتي' then
send(msg.chat_id_,msg.id_, '[اوعه ع الجمدان بقا حبيبتي وشغل عالي 🙈❤️](t.me/CH_POWLER)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ياحلولي هي فاكراني انسان ولا اي😹❤️](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعملو اي..😒💔](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بنهش كتاكيت احنا هنا ولا اى😒💔](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..🥺💔](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹🚶🏻‍♀💔](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يقطعني 😹🙆🏻‍♀♥️](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير ياعمري..❤️](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اعدل وشكك ونت بتكلمني 😒](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌚❤️](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصل حصوله 😹💜](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصلخير اي هيجي منين الخير وانت هنا. 🙂😂](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لاء متقولش نينينينني😹🏃🏻‍♀♥️](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجع تاني م حوارر 😹🚶🏻‍♀♥️](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/CH_POWLER)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي💋🥰](t.me/CH_POWLER)') 
return false
end
end
end
...
local msg_id = msg.id_/2097152/0.5
 keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽المطور₎ 𖣘 ',url="t.me/"..SUDOUSERNAME}}

,{{text = '  اضف البوت الي مجموعتك ',url="t.me/"..database:get(bot_id..":ubot").."?startgroup=start"}}

}
 

https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/'..database:get(bot_id..":ubot")..'&caption=' .. URL.escape('['..DRAGON_Msg[math.random(#DRAGON_Msg)]..']').."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'مين ضافني هنا' or text == 'مين ضافني' or text == 'هو مين ضافني' then
if not database:get(bot_id..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
...
if text == 'رابط حذف' or text == 'رابط الحذف' or text == 'بوت حذف' or text == 'بوت الحذف' or text == 'انا هحذف' then  
local Text = [[  
